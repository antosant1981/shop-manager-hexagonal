...
public class ApplicationContext {
    ...
    final CreateProduct createProduct = new CreateProductUseCase(transactionService, productRepository);
    final UpdateProduct updateProduct = new UpdateProductUseCase(transactionService, productRepository);
    final FindProduct findProduct = new FindProductQuery(productRepository);
    final DeleteProduct deleteProduct = new DeleteProductUseCase(productRepository);
}
